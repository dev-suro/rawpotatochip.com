...
GravityPoint.prototype = (function(o) {
    ...
    render: function(ctx) {
        ...
        var gravities = this._targets.gravities,
            g, absorp, area = this.radius * this.radius * Math.PI,
            garea;
...
(function() {
    var BACKGROUND_COLOR = 'rgba(11, 18, 55, 1)',
        PARTICLE_RADIUS = 1,
        G_POINT_RADIUS = 10,
        G_POINT_RADIUS_LIMITS = 65;
    var canvas, context, bufferCvs, bufferCtx, screenWidth, screenHeight, mouse = new Vector(),
        gravities = [],
        particles = [],
        grad, gui, control;
...
function switchMC() {
    if (document.getElementById('mcbox')) {
        if (document.getElementById('mcbox').style.display == 'none') {
            document.getElementById('mcbox').style.display = 'block';
            document.getElementById('mcdirbox').style.display = 'none';
        } else {
            document.getElementById('mcbox').style.display = 'none';
            document.getElementById('mcdirbox').style.display = 'block';
        }
    }
}